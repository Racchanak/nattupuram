...
$per_page = 10;
$sql = "SELECT count(distributors_id) FROM distributors where del_flag='N'";
...
$details = display_all_distributors();
?>
<style>
                    ...
                    <tbody>
                        ...
                        for ($i = $start; $i < $end; $i++) {
                            ...
                            <tr id='<?php echo $details[$i]['distributors_id']; ?>'>
                                ...
                                <td><?php echo $details[$i]['product']; ?></td>
